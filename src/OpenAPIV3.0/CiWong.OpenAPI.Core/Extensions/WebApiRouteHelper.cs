...
namespace CiWong.OpenAPI.Core
{
    ...
    {
        public static IHttpRoute MapHttpRouteWithNameSpace(this HttpRouteCollection routes, string name, string routeTemplate, object defaults, object constraints, string[] namespaces)
        {
            return routes.MapHttpRoute(name, routeTemplate, defaults, constraints, null, namespaces);
        }
        private static IHttpRoute MapHttpRoute(this HttpRouteCollection routes, string name, string routeTemplate, object defaults, object constraints, HttpMessageHandler handler, string[] namespaces)
        {
            if (routes == null)
            {
